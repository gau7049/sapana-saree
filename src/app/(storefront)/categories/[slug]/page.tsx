...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: category.description ?? `Browse our collection of ${category.name} sarees at ${SITE_NAME}.`,
...
export default async function CategoryPage({ params, searchParams }: Props) {
  ...
  const jsonLd = {
    ...
    description: category.description ?? `Browse ${category.name} sarees at ${SITE_NAME}`,
